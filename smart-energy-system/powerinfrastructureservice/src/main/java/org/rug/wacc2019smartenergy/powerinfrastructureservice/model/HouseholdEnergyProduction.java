...
// Source from Spring Documentation recommending time series organization
// https://docs.spring.io/spring-data/cassandra/docs/current-SNAPSHOT/reference/html/#cassandra-template.id-handling
@Table
public class HouseholdEnergyProduction {
    ...
    public HouseholdEnergyProduction() {
    }
